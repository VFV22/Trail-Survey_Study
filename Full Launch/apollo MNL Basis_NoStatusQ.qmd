...
#Filter data 
mlogit_clean_No.Status.Q<-mlogit_clean %>%
  filter(Chosen.Alternative!="3")
```

```{r}


mlogit_clean_No.Status.Q=mlogit_clean_No.Status.Q[c(1:11,15,19,38:47, 71)]
mlogit_clean_No.Status.Q$Alternative[which(mlogit_clean_No.Status.Q$Alternative==1)]="alt1"
mlogit_clean_No.Status.Q$Alternative[which(mlogit_clean_No.Status.Q$Alternative=="2")]="alt2"
mlogit_clean_No.Status.Q$Alternative[which(mlogit_clean_No.Status.Q$Alternative=="3")]="alt3"
#mlogit_clean$Choice.Binary=NULL
#Note design_ngene still says 50
# mlogit_clean$Cost[which(mlogit_clean$Cost==50)]=40
mlogit_clean_wide=reshape(mlogit_clean_No.Status.Q,timevar = "Alternative",
idvar = c(1:3,5,7),
