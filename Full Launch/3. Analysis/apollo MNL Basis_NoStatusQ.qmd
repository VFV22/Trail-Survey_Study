...
#Filter data 
#Pull out RID that only chooses alt 3
...
mlogit_clean_dropAlwaysOpt <- mlogit_clean %>%
  filter(!(RID %in% always_optout))
...
mlogit_clean_dropAlwaysOpt =mlogit_clean_dropAlwaysOpt [c(1:11,15,19,38:47, 71)]
mlogit_clean_dropAlwaysOpt$Alternative[which(mlogit_clean_dropAlwaysOpt$Alternative==1)]="alt1"
mlogit_clean_dropAlwaysOpt$Alternative[which(mlogit_clean_dropAlwaysOpt$Alternative=="2")]="alt2"
mlogit_clean_dropAlwaysOpt$Alternative[which(mlogit_clean_dropAlwaysOpt$Alternative=="3")]="alt3"
#mlogit_clean$Choice.Binary=NULL
#Note design_ngene still says 50
# mlogit_clean$Cost[which(mlogit_clean$Cost==50)]=40
mlogit_clean_wide=reshape(mlogit_clean_dropAlwaysOpt,timevar = "Alternative",
idvar = c(1:3,5,7),
