...
apollo_control <- list(
  modelName  = "Trail_Choice_lowcost",
  modelDescr = "Simple MNL model with lowcost as trail attribute",
  indivID    = "RID" ,
  panelData = TRUE
)
...
database=database[c(1,3,4,6,10,11:18,28,46, 55:73)]
